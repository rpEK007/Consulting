...
buf.push("<li><article" + (jade.attr("data-id", index, true, false)) + " class=\"post\"><div class=\"post-content\"><h4 class=\"post-title\"><a>" + (jade.escape(null == (jade.interp = val.title) ? "" : jade.interp)) + "</a></h4></div><div class=\"post-meta\"><ul class=\"meta-list\"><li><span class=\"black\">" + (jade.escape(null == (jade.interp = val.date) ? "" : jade.interp)) + "</span></li><li><a class=\"read-news\">Read<i class=\"icon-long-arrow-right\"></i></a></li></ul></div></article></li>");
    }
...
buf.push("</ul></div></div></div></div></footer>");;return buf.join("");
}
window.newsJSON = 
{
	"ua": [
